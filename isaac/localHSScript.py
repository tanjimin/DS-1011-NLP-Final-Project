...
for lang in ["vi", "zh"]:
    ...
    for j, i in enumerate(grid):
        ...
        if "\\" in os.getcwd():
            pp.get_figure().savefig(fig_dir+"local_att\\hs\\{}_hs_{}_loss".format(lang, str(i)), bbox_inches='tight')
        else:
            pp.get_figure().savefig(fig_dir+"local_att/hs/{}_hs_{}_loss".format(lang, str(i)), bbox_inches='tight')
        ...
        if "\\" in os.getcwd():
            pp.get_figure().savefig(fig_dir+"local_att\\hs\\{}_hs_{}_scores".format(lang, str(i)), bbox_inches='tight')
        else:
            pp.get_figure().savefig(fig_dir+"local_att/hs/{}_hs_{}_scores".format(lang, str(i)), bbox_inches='tight')
