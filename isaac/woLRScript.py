...
for lang in ["vi", "zh"]:
    ...
    for j, i in enumerate(grid):
        ...
        print("*******************************************************")
        print("*******************************************************")
        print("Running Leraning Rate: {} | {:.3}% Complete".format(i, j/len(grid)))
        print("*******************************************************")
        print("*******************************************************")
        print("*******************************************************")
        print("")
        ...
        pp.set_ylabel("Loss")
        pp.set_xlabel("Time")
        pp.get_figure().savefig(fig_dir+"wo_att\\hs\\{}_lr_{}_loss".format(lang, str(i)), bbox_inches='tight')
        ...
        pp.set_xlabel("Epoch")
        pp.get_figure().savefig(fig_dir+"wo_att\\hs\\{}_lr_{}_scores".format(lang, str(i)), bbox_inches='tight')
